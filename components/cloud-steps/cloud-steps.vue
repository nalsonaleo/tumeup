	...
	<view class="uni-steps">
		<view :class="[direction==='column'?'uni-steps__column':'uni-steps__row']">
			<view :class="[direction==='column'?'uni-steps__column-text-container':'uni-steps__row-text-container']">
				<view v-for="(item,index) in options" :key="index" :class="[direction==='column'?'uni-steps__column-text b-b':'uni-steps__row-text']">
					...
					<text class="color-disabled" :class="[direction==='column'?'uni-steps__column-desc':'uni-steps__row-desc']" v-if="item.time">{{item.time}}</text>
				</view>
			</view>
