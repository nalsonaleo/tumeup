<template>
	<view class="user-box">
		...
		<!--Head_box-->
		<view
			style="width: 100%;height: 100rpx;display: flex;flex-direction: column;left:0;top:0;color: #000000;background-color:white;justify-content: center;align-items:center;border-radius: 0px;z-index: 99;margin-top:130rpx;">
			<view
