		...
		<view class="content_box">
			<view class="detail-head">
				<view class="state-box x-f">
					...
					<text v-if="orderDetail.o_exchange == 0 && orderDetail.o_type !=5">{{ orderStatus[orderDetail.o_status] }}</text>
			...
			<view class="detail-goods">
				...
				<view class="order-list">
					...
					<view class="order-bottom  x-f" style="margin-top: -20upx;margin-bottom: 20upx;"  v-if="orderDetail.o_status == 0 || orderDetail.o_status == 1 || orderDetail.o_status == 2">
						<view class="btn-box" >
						...
						<button @tap.stop="onRefund(orderDetail.id)" class="cu-btn btn1" v-if="orderDetail.o_status == 7">
