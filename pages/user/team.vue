		...
		<view class="content">
			...
			<view class="con">
				<view class="list" v-for="(item,index)  in list" :key='index'>
					...
					<view class="right">
						<view class="text" style="color: #333;">{{item.u_name || item.u_phone}} <text  style="font-size: 28upx;margin-left: 30upx;">{{item.level_name}}</text></view>
						<view class="text" style="color: #666;font-size: 28upx;margin-top: 16upx;">{{item.u_phone}}</view>
					</view>
				</view>
